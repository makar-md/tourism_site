        ...
        <div id="register" className="w-full max-w-md sm:max-w-lg md:max-w-2xl border border-zinc-300 dark:border-zinc-700 rounded-2xl flex flex-col items-center p-4
          sm:p-6 md:p-8 ">
              ...
              <div className="flex flex-col w-full p-2 space-y-2 sm:space-y-3">
                  ...
                  <div className="flex flex-col gap-2">
                      <Input type="text" name="surName" label="surName" value={data.surName} onChange={handleChange} placeholder="Ivanov" />
                  </div>
                  <div className="flex flex-col gap-2">
                      <Input type="text" name="firstName" label="firstName" value={data.firstName} onChange={handleChange} placeholder="Ivan" />
                  </div>
                  <div className="flex flex-col gap-2">
                      <Input type="text" name="lastName" label="lastName" value={data.lastName} onChange={handleChange} placeholder="Ivanovich" />
                  </div>
                  <div className="flex flex-col gap-2">
                      <Input type="password" name="password" label="Password" value={data.password} onChange={handleChange} placeholder="password"/>
                  </div>
                  <div className="flex flex-col gap-2">
                      <Input type="password" name="confirmPassword" label="Confirm password" value={data.confirmPassword} onChange={handleChange} placeholder="password"/>
                  </div>
              </div>
