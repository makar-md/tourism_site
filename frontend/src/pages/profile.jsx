                ...
                <div className='flex justify-between'>
                    <div className="flex flex-col basis-1/2 py-2 space-y-2 sm:space-y-3 px-6">
                        <div className="flex flex-col gap-2">
                            <InputCustom type="email" name="email" label="Email" value={userData.email} onChange={handleChange} placeholder="test@mail.ru" peerText="Please provide a valid email address."/>
                        </div>
                        <div className="flex flex-col gap-2">
                            <InputCustom type="text" name="surName" label="surName" value={userData.surName} onChange={handleChange} placeholder="Ivanov" />
                        </div>
                        <div className="flex flex-col gap-2">
                            <InputCustom type="text" name="firstName" label="firstName" value={userData.firstName} onChange={handleChange} placeholder="Ivan" />
                        </div>
                        <div className="flex flex-col gap-2">
                            <InputCustom type="text" name="lastName" label="lastName" value={userData.lastName} onChange={handleChange} placeholder="Ivanovich" />
                        </div>
                        <div className="flex flex-col gap-2">
                            <InputCustom type="password" name="password" label="New Password" value={userData.password} onChange={handleChange} placeholder="password"/>
