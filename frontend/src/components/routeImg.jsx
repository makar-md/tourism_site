export default function RouteImg({index, file, onDelete}){
    return(
        <div key={index} className="relative shrink-0 group">
            <img src={URL.createObjectURL(file)} className="w-42 h-42 rounded-2xl object-cover shadow-xl shadow-zinc-900/40 transition group-hover:brightness-50" />
